...
const Navbar = () => {
  ...
  const GuidelineSchedule = () => {
    return (
      <div className={styles.navbar__guideline__schedule}>
  ...
  const GuidelineAbout = () => {
    return (
      <div className={styles.navbar__guideline__about}>
        <p>About the Game:</p>
        <ol>
  ...
  const GuidelineTips = () => {
    return (
      <div className={styles.navbar__guideline__tips}>
        <p>Tips and Tricks:</p>
  ...
  const GuidelineWinning = () => {
    return (
      <div className={styles.navbar__guideline__winning}>
